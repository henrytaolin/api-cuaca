function getData(location) {
    return fetch("https://data.bmkg.go.id/DataMKG/MEWS/DigitalForecast/DigitalForecast-DKIJakarta.xml")
...
weatherPanel(["Jakarta Timur", "Jakarta Utara", "Jakarta Pusat", "Jakarta Selatan", "Jakarta Barat"])